...

{
	...
	public Object[][] getchangePwdData(Method m) throws IOException {
		...
		File src=new File("path/to your excel file");
		//load the excel file
	...
	{
		File src = new File(System.getProperty("user.dir") + "//src//test//java//com//testData//Sincxdata2.xlsx");
		FileInputStream excel=new FileInputStream(src);
		//FileInputStream excel=new FileInputStream("C:\\Users\\priya\\IdeaProjects\\SincX\\src\\test\\java\\com\\testData\\Sincxdata2.xlsx");
