...
public class ReadConfig 
{
	...
	public ReadConfig()
	{
		...
		//File src = new File("/Users/ankitabharadhwaj/IdeaProjects/SincX/Configuration/config.properties");// Creating File object
		try 
		{
	...
	{
		String domainname=pro.getProperty("domainname");
		return domainname;
	}
